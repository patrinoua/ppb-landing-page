...
function Contact() {
  ...
  return (
    <div style={{ margin: '50px', maxWidth: '1000px' }}>
      <h2>PingPongBuddies Privacy Policy</h2>
      Welcome to the PingPongBuddies Privacy Policy ("Policy")! This explains
      how we collect, store, protect, and share your information, and with whom
      we share it. If you have any questions or comments about this Policy,
      please feel free to contact us at pingponistas@gmail.com.
      ...
      <p>
        ...
        connect to your PingPongBuddies Account (this could include, for
        example, your Facebook and Instagram accounts ("Social Media Accounts").
        You will also be required to create a password in connection with the
      ...
      <p>
        ...
        of PingPongBuddies, for example if you use our messaging function.
      </p>
      <p>
      ...
      <p>
        ...
        certain PingPongBuddies Badges to your profile, such as your religion
        and political leanings. While you may voluntarily provide this
        information to us when you create your profile, there is no requirement
        to do so. Please remember that photographs that you post on
        PingPongBuddies may reveal information about yourself as well. Where you
        do upload and choose to tell us sensitive information about yourself,
        including through adding certain Badges to your profile, you are
        explicitly consenting to our processing of your information and making
        this public to other users.
      </p>
      <p>
        ...
        on PingPongBuddies. If you post anything that is inconsistent with our
        Terms and Conditions of Use, we reserve the right to terminate your
        Account - we really don't want to have to do this so please play by the
        rules!
      </p>
      <p>
        ...
        also want to avoid fake PingPongBuddies accounts being created which can
        be used for malicious activities and cybercrime – they threaten the
        PingPongBuddies network and spoil things for everyone. We use a third
        party provider for account verification who will keep your phone number
        for up to 90 days for fraud identification purposes. We collect and use
        your phone number on the basis of our legitimate interests identified in
        section 11 below and for the prevention of fraud.
      </p>
      <p>
      ...
      <p>
        To prevent abuse of the app/site, PingPongBuddies uses automated
        decisions and moderators to block accounts as part of its moderation
        procedures. In order to do this, we check accounts and messages for
        content that indicates breaches of our Terms and Conditions of Use. This
        is done through a combination of automated systems and our team of
        moderators. If an account or message meets certain criteria that
        demonstrate that the Terms and Conditions of Use are likely to have been
        breached, the relevant account will automatically be blocked. All users
        of accounts that have been blocked will be notified that their account
        has been blocked and affected users can contact PingPongBuddies to
        contest the decision.
      </p>
      <p>
        PingPongBuddies also uses automated decisions to prevent fraudulent
        ...
        for behavior that indicates breaches of our Terms and Conditions of Use.
        If a transaction meets certain criteria that demonstrate that the Terms
        and Conditions of Use are likely to have been breached and the
        ...
        users can contact PingPongBuddies to contest the decision.
      </p>
      <p>
      ...
      <p>
        ...
        optionally provided us with via PingPongBuddies Badges) to drive
        targeted advertising in our legitimate interest, via promo cards and ads
        on our App. We also process limited data (device identifiers) and share
        this with third party advertising networks which host our ads. You can
        stop targeted advertising within the “Contact & FAQ” page accessible via
        your profile. If you opt-out of targeted advertising you will still see
      ...
      <p>iPhone app — settings, privacy, location services, PingPongBuddies</p>
      <p>
        Android — settings, location, PingPongBuddies, permissions, location
      </p>
      ...
      <p>
        ...
        security incidents from opening a new account. Where PingPongBuddies
        uses machine learning, for example, to help us detect and prevent
        fraudulent card transactions, and to detect and prevent spam
        communications on the App (as explained above), we may need to keep
        personal information for a longer period than the retention periods
        explained above, to enable the machine learning to work properly. Where
        this is the case, we always seek to minimize the amount of personal
        information that is used and we ensure that it is ring-fenced and kept
        securely from other user personal information. We regularly review the
        period for which personal information is required for machine learning
        purposes and delete any identifiable information when it is no longer
        required.
      </p>
      ...
      <p>
        ...
        PingPongBuddies including third party services and clients by
      ...
      <p>
        ...
        PingPongBuddies, which in turn helps us make a better product for you!
        Cookies store information about your website visits and can recognize
        you and your preferences each time you visit the PingPongBuddies site.
        They help us to provide a better service to you!
      </p>
      <p>
        PingPongBuddies’ use of cookies and local storage devices is basically
        related to the performance of PingPongBuddies’ site, such as analytics
        that help us determine how our site is performing and ensuring a smooth
        and trouble-free experience for our members and visitors.
      </p>
      <p>
        Below is a table to explain PingPongBuddies’ cookie functions and why
        they’re used.
      </p>
      <p>
        If for any reason you decide that you do not want all of your
        PingPongBuddies activities to be stored you may set your browser and
        mobile settings to block cookies and local storage devices, but please
        remember that if you do so, you may not be able to access all of the
        features PingPongBuddies offers!
      </p>
      ...
      <p>
        Our main goal is to ensure your experience on PingPongBuddies is an
        enjoyable one and you don't end up getting stung! In order to deliver an
      ...
      <p>
        ...
        very important that all PingPongBuddies behave whilst using the App. We
        will cooperate with all third parties to enforce their intellectual
        property or other rights. We will also cooperate with law enforcement
        enquiries from within or outside your country of residence where we are
        required to by law, where there is an investigation into alleged
        criminal behaviour or to protect the vital interests of a person. This
        may include preserving or disclosing any of your information, including
        your Registration Information, if we believe in good faith that it is
        ...
        personal data that PingPongBuddies holds about you, depending on the
        nature of the request or the issue that we are dealing with, including
        all CCPA Categories listed above
      </p>
      <p>
        Business Transfers -In the event that PingPongBuddies or any of our
        affiliates undergoes a business transition or change of ownership, such
        as a merger, acquisition by another company, re-organisation, or sale of
        all or a portion of its assets, or in the event of insolvency or
        administration, we may be required to disclose your personal data. This
        could include all personal data that PingPongBuddies holds about you,
        including all CCPA Categories listed above
      </p>
      <p>
      ...
      <p>
        Anti-Spam and Anti-Fraud -Your data may be shared with other
        PingPongBuddies group companies, for example, to block accounts and
        suspected fraudulent payment transactions as part of our anti-spam and
        anti-fraud procedures. Email address, phone number, IP address and IP
        session information, social network ID, username, user agent string, and
        transaction and payment data (CCPA Categories B, F and D). Aggregated
        Information – We may share aggregated information with third parties
        that includes your personal data (but which doesn’t identify you
        directly) together with other information including log data for
        industry analysis and demographic profiling. You may opt-out of
        receiving marketing messages by using the opt-out mechanisms and links
      ...
      <p>
        PingPongBuddies does not sell your data and has not sold your personal
        data in the previous 12 months.
      </p>
      <h4>4. WHAT OTHERS MAY SEE ABOUT YOU.</h4>
      <p>
        We think our PingPongBuddies are awesome, and we want you to share how
        ...
        with other Users and to interact with them. If you register or log in to
        the App using your Facebook account, you are authorizing us to access
        ...
        friends you have in common with other PingPongBuddies. You also
        understand that your PingPongBuddies profile and other information you
        make available via the App, including information you provide directly
        or indirectly through Facebook (i.e., your Facebook photos, your name,
        age, approximate location, friends you have in common with other
        PingPongBuddies and other profile information), may be viewed and shared
        by PingPongBuddies with individuals who may or may not be Users or via
        third party applications in such PingPongBuddies’ discretion. For
        example, a User may recommend you as a match to his or her Facebook
        friends by sharing your picture, regardless of whether such friend(s) is
        also a User of the App. You might share information like the photos and
      ...
      <p>
        When using PingPongBuddies, you should assume that anything you post or
        submit on the App may be publicly-viewable and accessible, both by Users
        of the App and non-Users of the App. We want our PingPongBuddies to be
        careful about posting information that will eventually be made public.
      </p>
      <p>
        If you log in to or access PingPongBuddies through your Facebook
        profile, remember to log off Facebook when you leave a device in order
        to prevent other users from accessing your account.
      </p>
      <h4>5. MODIFYING YOUR REGISTRATION INFORMATION.</h4>
      <p>
      ...
      <p>
        To prevent abuse and/or misuse of PingPongBuddies by a User following
      ...
      <h4>6. OUR POLICY TOWARDS AGE.</h4>
      <p>
        ...
        PingPongBuddies is cool, but you'll have to come back when you're old
        enough!
      </p>
      <p>
        PingPongBuddies does not knowingly collect any information about or
        market to children, minors or anyone under the age of 18. If you are
        less than 18 years old, we request that you do not submit information to
        us. If we become aware that a child, minor or anyone under the age of 18
        has registered with us and provided us with personal information, we
        will take steps to terminate that person's registration and delete their
        Registration Information from PingPongBuddies. If we do delete a profile
        because you violated our no children rules, we may retain your email and
        IP address to ensure that you do not try to get around our rules by
        creating a new profile.
      </p>
      <h4>7. CHANGES TO THIS POLICY.</h4>
      <p>
        As PingPongBuddies evolves, we may revise this Privacy Policy from time
        to time. The most current version of the policy will govern our use of
        your information and will always be at PingPongBuddies.com/privacy/. If
        ...
        associated with your Account or by posting a notice within
        PingPongBuddies. By continuing to access or use the App after those
        changes become effective, you agree to be bound by the revised Privacy
        Policy.
      </p>
      <h4>8. SECURITY.</h4>
      <p>
        Here at PingPongBuddies we pride ourselves on taking commercially
        reasonable security measures to help protect your information against
        loss, misuse and unauthorized access, or disclosure. We use reasonable
      ...
      <h4>9. THIRD PARTY ACCOUNTS.</h4>
      <p>
        If you have registered with PingPongBuddies using a third party social
        media platform, such as Facebook, your PingPongBuddies profile will be
        available to all Users of PingPongBuddies whether via our App or our
        partners' websites.
      </p>
      <p>
        ...
        policies as PingPongBuddies does not control how they use their
        information.
      </p>
      <p>
        ...
        we may connect your PingPongBuddies profile with your profile on such
        website. We may do this by way of new products and applications which we
        introduce from time to time, including new products powered by our group
        companies.
      </p>
      <p>
        If you have created a PingPongBuddies profile through a third party
        website and you do not want to link your PingPongBuddies profile to your
        profile on the third party website, PingPongBuddies cannot amend these
        settings. Please visit the application settings on your third party
        website profile and follow the instructions to remove the
        PingPongBuddies access permissions.
      </p>
      <p>
      ...
      <h4>10. YOUR UK AND EU RIGHTS.</h4>
      <p>
      ...
      <p>
        ...
        in the decision-making process. PingPongBuddies has designated a Data
        Protection Officer and they can be reached by emailing
        pingponistas@gmail.com
      </p>
      <p>
        If you want to exercise any of your rights listed above please visit our
        Feedback Page or email us at pingponistas@gmail.com. You can also
        contact us by post at the address above.
      </p>
      <p>
        How does PingPongBuddies protect my personal data? PingPongBuddies has
        implemented appropriate security measures to protect and prevent the
        loss, misuse, and alteration of the information under our control,
        including your personal data. Our technical experts at PingPongBuddies
      ...
      <p>
        ...
        with that service provider as you have with PingPongBuddies, your
        personal data may be compromised. If that happens, please report it to
        Support via our Feedback Page.
      </p>
      <p>
        Where is my personal data kept? We want you to be able to access
        PingPongBuddies wherever you happen to be in the world. To enable us to
        provide that service, we operate a global network of servers including
        in the US, Hong Kong, Czech Republic and Russia. The hardware is located
        in third-party data centres but is owned by the PingPongBuddies group.
        Data collected by advertising partners may also be held outside the
        European Economic Area. We ensure that the data is adequately protected
        by ensuring that valid, legal mechanisms are in place such as: EU
        approved model clauses (which can be found here), US privacy shield
        certification (more information can be found here – please note that
        PingPongBuddies is not Privacy Shield certified but we may pass
        information to third party service providers or advertising partners who
        are based in the US and who are Privacy Shield certified); and
        implementing robust contractual standards. If you want more information
        relating to the nature of the safeguards we have in place, please email
        pingponistas@gmail.com.
      </p>
      <p>
        Does PingPongBuddies collect any other personal data about me? If you
        contact our Customer Support team via our Feedback Page, we will receive
        your email address, and may track your IP address, as well as the
        information you send to us to help resolve your query. We will keep
        ...
        2 years after deletion of your account.
      </p>
      <p>
        Does PingPongBuddies use my personal data for any other purpose? We may
        use material that you post on the open access areas of PingPongBuddies
        in advertising and promotional materials on our partner sites and
        partner products. We believe these uses are in line with our legitimate
      ...
      <p>
        To enable users to create their PingPongBuddies profile and log into the
        app via Facebook Data from Facebook, including email address, name and
        profile picture, date of birth, friends who use the app, pages liked,
        location and photos (CCPA Categories A, B, C, and H) We obtain this
        information from Facebook Legitimate interests – it is in our legitimate
        interests to facilitate access to our services
      </p>
      <p>
